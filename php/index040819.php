...
$ventas = mysql_query("SELECT (SELECT SUM(total) FROM ventas_articulos WHERE idventa=ventas.idventas - ventas.descuento) as total FROM ventas WHERE ventas.fecha = CURDATE()");
$tventas = 0;
